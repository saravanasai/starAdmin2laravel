...
<html>
   ...
   <body>
      ...
      <!-- arrival section -->
      @include('Layout.frontend.Arrivals')
      <!-- end arrival section -->
      
      <!-- product section -->
     @include('Layout.frontend.partials.Products')
      <!-- end product section -->

      <!-- subscribe section -->
      @include('Layout.frontend.partials.subscribe')
      <!-- end subscribe section -->
      <!-- client section -->

       {{-- @include('Layout.frontend.partials.Testimonial') --}}
